...
private object `er ikke kode 6 eller 7` : Synlighetsregel {
    override fun erSynlig(kandidat: Kandidat): Boolean {
        if (kandidat.oppfølgingsinformasjon == null) {
            return false
        }

        val diskresjonskode = kandidat.oppfølgingsinformasjon.diskresjonskode ?: return true
        return diskresjonskode != "6" && diskresjonskode != "7"
    }
