        ...
        <body style="font-family: sans-serif; padding: 40px 20px; color: #23262A">
            ...
            <div style="padding: 16px; margin-bottom: 24px; border-radius: 12px; background-color:#F2F3F5;">
                <ol style="margin: 0px; padding-left: 24px;">
                    <li style="margin-bottom: 8px;">Åpne <a href="#" style="text-decoration:none; color:#000000; cursor: default; font-weight: bold;">https://arbeidsgiver.nav.no/min-side-arbeidsgiver</a></li>
            ...
            <div style="font-size: 16px; padding: 24px 24px; border-radius: 12px; background-color: #F2F3F5;">
                <p style="padding: 0px; margin-bottom: 8px; margin-top: 0px">Tilgangen til NAVs rekrutteringstjenester styrer arbeidsgivere selv i <b>Altinn</b>.</p>
                <p style="margin-bottom: 8px;">For å få tilgang må du kontakte den som styrer tilgangene til virksomheten din. Det kan være noen i HR, en leder, mellomleder, eller noen på eiersiden i virksomheten.</p>
                <p style="margin-bottom: 8px;">Vi har lagd en oppskrift du kan dele med vedkommende for å gjøre det enklere for dem å gi deg tilgang.</p>

                <h3 style="font-size: 16px; line-height: 16px; font-weight: 500; margin: 40px 32px">Kopier den gjerne og send den til vedkommende:</h3>
                <div style="font-size: 16px; padding:24px 24px; border-radius: 12px; border: 3px dashed #CBCFD5; background-color: #FFFFFF;">
                    <p style="padding: 0px; margin-bottom: 8px; margin-top: 0px">Du får denne meldingen fordi avsender ønsker å få tilgang til CV-er fra NAV på vegne av virksomheten din. </p>
