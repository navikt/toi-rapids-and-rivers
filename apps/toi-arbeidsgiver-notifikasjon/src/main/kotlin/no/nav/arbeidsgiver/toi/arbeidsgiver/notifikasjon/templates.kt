...
val epostTemplate = """
    ...
    <html>
        ...
        <body style="font-family: sans-serif; padding: 40px 20px; color: #23262a">
            <h1 style="font-size: 32px; font-weight: bold">Hei.</h1>
            <p>
                Vi har funnet nye kandidater for deg til stillingen:
                <b id="stillingstittel">$TITTEL</b>.
            </p>
            <pre style="font-family: sans-serif; margin-top: 32px; margin-bottom: 32px" id="tekst">
    $TEKST</pre
            >
            ...
            <div
                ...
                "
            >
                <ol style="margin: 0px; padding-left: 24px">
                    <li style="margin-bottom: 8px">
                        ...
                        <a
                            ...
                            style="
                                ...
                                font-weight: bold;
                            "
                            >https://arbeidsgiver.nav.no/min-side-arbeidsgiver</a
                        >
                    </li>
                    <li style="margin-bottom: 8px"><b>Logg inn</b></li>
                    <li>
                        Finn <b>varslene dine</b> oppe til høyre på siden, og trykk deg inn på
                        meldingen, eller finn lenken i kortet med teksten
                        <b>Kandidater til mine stillinger</b> lenger ned på siden.
                    </li>
                </ol>
            </div>
            ...
            <h2 style="font-size: 16px; margin-bottom: 24px">
                Mangler du tilgang til Min Side for Arbeidsgiver hos NAV?
            </h2>
    
            <div style="padding: 24px; border-radius: 12px; background-color: #f2f3f5">
                <p style="margin-top: 0">
                    Tilgangen til NAVs rekrutteringstjenester styrer arbeidsgivere selv i <b>Altinn</b>.
                </p>
                <p>
                    For å få tilgang må du kontakte den som styrer tilgangene til virksomheten din. Det
                    kan være noen i HR, en leder, mellomleder, eller noen på eiersiden i virksomheten.
                </p>
                <p>
                    Vi har lagd en oppskrift du kan dele med vedkommende for å gjøre det enklere for dem
                    å gi deg tilgang.
                </p>
                ...
                <div
                    style="
                        padding: 24px;
                        border: 3px dashed #cbcfd5;
                        border-radius: 12px;
                        background-color: #ffffff;
                    "
                >
                    <p style="margin-top: 0">
                        Du får denne meldingen fordi avsender ønsker å få tilgang til CV-er fra NAV på
                        vegne av virksomheten din.
                    </p>
                    ...
                    <ol>
                        ...
                        <li>
                            Skriv «Rekruttering», så vil alternativet komme opp som et valg. Velg
                            «Rekruttering».
                        </li>
                        <li>Bekreft</li>
                    </ol>
                    <p>
                        Denne enkeltrettigheten gir kun tilgang til å bruke NAV sine
                        rekrutteringstjenester: publisere stillingsannonser og holde videomøter for
                        stillinger på Arbeidsplassen, og motta CV-er fra NAV på
                        <a
                            href="#"
                            style="
                                text-decoration: none;
                    ...
                    <ul>
                        <li>
                            Du er registrert i Enhetsregisteret som daglig leder, styrets leder,
                            bestyrende reder eller innehaver.
                        </li>
                        <li>Du er registert som hovedadministrator i Altinn.</li>
                        <li>
                            Du er «Tilgangsstyrer» i Altinn og har én, eller flere av rollene:
                            «Rekruttering», «Lønn og personalmedarbeider», eller «Utfyller/innsender».
                        </li>
                    </ul>
                </div>
            </div>
