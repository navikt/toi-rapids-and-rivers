...
val consumerConfig = mapOf(
    CommonClientConfigs.CLIENT_ID_CONFIG to "toi-arbeidssoekeropplysninger",
    CommonClientConfigs.GROUP_ID_CONFIG to System.getenv("ARBEIDSSOKER_OPPLYSNINGER_KAFKA_GROUP_ID"),
