...
fun startRapid(
    ...
    try {
        rapidsConnection.also { rapid ->
            ...
            //SamleLytter(rapid, repository, "arbeidssokerperiode")
            //SamleLytter(rapid, repository, "arbeidssokeropplysninger")
            ...
            //NeedLytter(rapid, repository, "arbeidssokerperiode")
            //NeedLytter(rapid, repository, "arbeidssokeropplysninger")
        }.start()
    } catch (t: Throwable) {
