...
class Behandler(val repository: Repository, val publiserHendelse: (String) -> Unit) {
    ...
    fun behandleHendelse(hendelse: Hendelse) {
        ...
        val oppdatertKandidat = when (hendelse.hendelseType) {
            ...
            HendelseType.FRITATT_KANDIDATSØK -> kandidat.copy(fritattKandidatsøk = hendelse.jsonMessage["fritattKandidatsok"])
        }
        ...
        oppdatertKandidat.fritattKandidatsøk?.let { hendelse.jsonMessage["fritattKandidatsok"] = it }
