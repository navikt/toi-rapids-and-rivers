...
val consumerConfig = mapOf(
    CommonClientConfigs.CLIENT_ID_CONFIG to "toi-arbeidssoekerperiode",
    CommonClientConfigs.GROUP_ID_CONFIG to System.getenv("ARBEIDSSOKER_PERIODE_KAFKA_GROUP_ID"),
